...
## 1. 기초자치단체장 지방선거 시각화를 위한 사전 준비 {#pre-condition-for-spatial-analysis}
...
1. 지도 파일: `.shp` 파일
1. 행정동 코드: 엑셀 파일
1. 광역단체장 선거 데이터: 위키백과 사전 [대한민국_제6회_지방_선거 - 기초자치단체장](https://ko.wikipedia.org/wiki/%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD_%EC%A0%9C6%ED%9A%8C_%EC%A7%80%EB%B0%A9_%EC%84%A0%EA%B1%B0_%EA%B8%B0%EC%B4%88%EC%9E%90%EC%B9%98%EB%8B%A8%EC%B2%B4%EC%9E%A5)
...
1. 지도 파일: [대한민국 최신 행정구역(SHP) 다운로드 - 시군구](http://www.gisdeveloper.co.kr/?p=2332)
...
## 2. 기초자치단체장 선거결과 공간정보 시각화 {#jibang-vote-spatial-data-visualization}
